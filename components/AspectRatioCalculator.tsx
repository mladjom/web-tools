...
const AspectRatioCalculator: React.FC = () => {
  ...
  const getGcd = useCallback((a: number, b: number): number => {
    while (b) {
      [a, b] = [b, a % b];
    }
    return a;
  ...
  const analyzeAspectRatio = useCallback((width: number, height: number): AspectRatioAnalysis => {
    ...
    const closest = Object.entries(COMMON_RATIOS).reduce(
      (closest, [key, value]) => {
  ...
  const suggestCropDimensions = useCallback(
    (width: number, height: number, target_ratio: number): CropSuggestion => {
  ...
  const PreviewBox = React.memo(
    ({ contentWidth, contentHeight, containerWidth, containerHeight }: {
      ...
      return (
        <div
          className="bg-muted w-full h-64 relative flex items-center justify-center max-w-[400px] mx-auto"
          style={{
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {Object.entries(COMMON_RATIOS).map(([name, { description }]) => (
              ...
              <div>
                <Label htmlFor="targetRatio">Target Crop Ratio</Label>
                <Select
                  value={targetRatio.toString()}
                  onValueChange={(value) => setTargetRatio(Number(value))}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select target ratio" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (value > 0) setDimensions(prev => ({ ...prev, width: value }));
                    }}
                  />
                  <Button
                    variant="outline"
                    ...
                    aria-label="Copy width to clipboard"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      const value = Number(e.target.value);
                      if (value > 0) setDimensions(prev => ({ ...prev, height: value }));
                    }}
                  />
                  <Button
                    variant="outline"
                    ...
                    aria-label="Copy height to clipboard"
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
                </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    const value = Number(e.target.value);
                    if (value > 0) setScreenDimensions(prev => ({ ...prev, width: value }));
                  }}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    const value = Number(e.target.value);
                    if (value > 0) setScreenDimensions(prev => ({ ...prev, height: value }));
                  }}
                />
              </div>
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        aria-label="Copy display dimensions to clipboard"
                      >
                        <Copy className="h-4 w-4" />
                      </Button>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        aria-label="Copy crop dimensions to clipboard"
                      >
                        <Copy className="h-4 w-4" />
                      </Button>
                    </div>
